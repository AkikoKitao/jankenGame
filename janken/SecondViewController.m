...
- (void)janken_sound {
    NSURL *jankenM4AURL = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"osaka_janken" ofType:@"m4a"]];
...
//    AudioServicesDisposeSystemSoundID(aikoSoundId);
}
...
- (void)janken {
//    self.lbl_mes.text = @"おおさかじゃんけん・・・ぽん";
...
- (void)viewDidLoad
{
    ...
    kati_img = [UIImage imageNamed:@"kati1.jpg"];
    make_img = [UIImage imageNamed:@"make2.jpg"];
}
